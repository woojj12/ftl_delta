...
#define NUM_GC_BUFFERS		(GTD_SIZE_PER_BANK)

#define DRAM_BYTES_OTHER	((NUM_GC_BUFFERS + NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS) * BYTES_PER_PAGE \
...
#define GC_BUF(INDEX)		(GC_BUF_ADDR + (INDEX) * BYTES_PER_PAGE)

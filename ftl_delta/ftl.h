...
#define DRAM_BYTES_OTHER	((NUM_LPA_BUFERS + NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS + NUM_DELTA_BUFFERS) * BYTES_PER_PAGE + BAD_BLK_BMP_BYTES \
                             + FTL_BMT_BYTES)
...
#define BAD_BLK_BMP_ADDR	(LPA_BUF_ADDR + LPA_BUF_BYTES)				// bitmap of initial bad blocks

...
#define DRAM_BYTES_OTHER	((NUM_GC_BUFFERS + NUM_LPA_BUFFERS + NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS + NUM_DELTA_BUFFERS) * BYTES_PER_PAGE + BAD_BLK_BMP_BYTES \
                             + FTL_BMT_BYTES)

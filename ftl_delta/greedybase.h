...
#define NUM_DELTA_TEMP_BUFFURS	2

#define DRAM_BYTES_OTHER	(((NUM_DELTA_BUFFERS + NUM_DELTA_TEMP_BUFFURS + NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS) * BYTES_PER_PAGE \
...
#define DELTA_TEMP_BUF_ADDR	(DELTA_BUF_ADDR + DELTA_BUF_BYTES)
#define DELTA_TEMP_BUF_BYTES (NUM_DELTA_TEMP_BUFFURS * BYTES_PER_PAGE)

#define BAD_BLK_BMP_ADDR	(DELTA_TEMP_BUF_ADDR + DELTA_TEMP_BUF_BYTES)				// bitmap of initial bad blocks
